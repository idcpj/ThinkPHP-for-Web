  ...
  <!-- /.navbar-collapse -->
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- /.row -->
            <div class="row">
                <form action="/admin.php" method="get" style="width: 60%">
                    ...
                    <div class="table-responsive">
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <tbody>
                                <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><a href="javascrtpt:void(0)">
                                                <span class="glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($menu["menu_id"]); ?>"></span>
                                            </a>
                                            <a href="javascrtpt:void(0)"  attr-id="<?php echo ($menu["menu_id"]); ?>" id="singcms-delete" attr-a="menu" attr-message="删除">
