...
CREATE TABLE `cms_admin` (
  ...
  `lastlogintime` (10) unsigned DEFAULT '0',
...
CREATE TABLE `cms_menu` (
  ...
  `parentid` smallint(6) NOT NULL DEFAULT '0' COMMENT '所属父类',
  `m` varchar(20) NOT NULL DEFAULT '' COMMENT '模型类',
  `c` varchar(20) NOT NULL DEFAULT '' COMMENT '控制器类',
  `f` varchar(20) NOT NULL DEFAULT '' COMMENT '方法类',
  `data` varchar(100) NOT NULL DEFAULT '',
  `listorder` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT'排列顺序',
  `status` tinyint(1)  NOT NULL DEFAULT '1',
  `type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '判断属于前台还是后台',
  PRIMARY KEY (`menu_id`),
...
CREATE TABLE `cms_news` (
  ...
  `listorder` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '判断文章是否置顶',
  `status` tinyint(1)  NOT NULL DEFAULT '1',
